...
#   John Lewandowski, 08/11/24, Initial attempt at assignment
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    def first_name(self) -> str:
        ...
        :return: First name w/ formatting
        '''
        return self._first_name.title()

    @first_name.setter
    def first_name(self, value: str) -> None:
        '''Sets the first name, while validating formatting
    ...
    def last_name(self) -> str:
        ...
        :return: last name w/ formatting
        '''
        return self._last_name.title()

    @last_name.setter
    def last_name(self, value: str) -> None:
        '''Sets the last name, while validating formatting
        :param value: The value to set
        '''
        if value.isalpha():
...
def read_data_from_file(file_name: str, student_data: list[Student]) -> list[Student]:
    ...
    for row in file_data:
        student_data.append(
            Student(row['first_name'], row
        ['last_name'], row['course_name'])
        )
    return student_data
